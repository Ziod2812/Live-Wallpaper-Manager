 ...
 *     infrequent (10s -- was 3s) status check for the three conditions
 *     Hyprland has no event for (screen lock, monitor DPMS, GameMode) --
 *     same "infrequent poll for something slow-changing" precedent
 *     already set by PowerService's own 45s battery poll.
 *
...
QtObject {
    ...
    property Timer pollTimer: Timer {
        id: pollTimer
        interval: 10000  // was 3000 - screen lock/monitor sleep/gaming don't change this fast
        repeat: true
