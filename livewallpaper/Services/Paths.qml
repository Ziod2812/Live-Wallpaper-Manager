...
QtObject {
    ...
    readonly property string logDir: stateHome + "/LiveWallpaperLogs"
    ...
    readonly property string performanceProfilesFile: dataDir + "/performance_profiles.json"
    ...
    readonly property string transitionRequestFile: cacheDir + "/transition-request.json"
