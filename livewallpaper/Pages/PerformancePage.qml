 ...
 * PerformancePage.qml
 * -----------------------
 * Performance settings: advanced performance controls, Smart Playback,
 * GPU selection, system stats, and cache management.
 *
...
Item {
    ...
    function focusSettingSearch(query) {
        ...
        const matches = [
            ...
            { text: "file converter convert video image audio convert.to.it", y: fileConverterPanel.y },
            ...
            { text: "adaptive fps thermal protection battery profiles gpu temperature", y: advancedPerformancePanel.y }
        ];
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            PerformanceAdvancedPanel {
                id: advancedPerformancePanel
                Layout.fillWidth: true
            }
