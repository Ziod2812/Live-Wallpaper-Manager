        ...
        Repeater {
            ...
            delegate: RowLayout {
                ...
                FileView {
                    ...
                    watchChanges: true
                    // printErrors: false -- onLoadFailed below already treats
                    // a missing state file as the normal/expected case, so
                    // there's no need for Quickshell to log it as a warning.
                    printErrors: false
