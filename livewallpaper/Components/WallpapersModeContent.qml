...
Item {
    ...
    ColumnLayout {
        ...
        WallpaperGrid {
            ...
            onCollectionRequested: wp => {
                collectionDialog.wp = wp;
                collectionDialog.open = true;
            }
        }
    ...
    // Collections (WallpaperCard's "+" button) -- same overlay-sibling
    // reasoning as previewDialog above.
